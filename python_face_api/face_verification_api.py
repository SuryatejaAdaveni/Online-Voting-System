...
def verify_face():
    try:
        ...
        print("Error processing /api/verify-face request:")
        print(traceback.format_exc())
        return jsonify({"match": False, "message": "Internal server error during face verification"}), 500
